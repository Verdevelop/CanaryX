...
export const getBalances = createAsyncThunk(
  ...
  async ({ address, networkID, provider }: IBaseAddressAsyncThunk) => {
    ...
    const shecContract = new ethers.Contract(addresses[networkID].SCNYA_ADDRESS as string, ierc20Abi, provider);
...
export const loadAccountDetails = createAsyncThunk(
  ...
  async ({ networkID, provider, address }: IBaseAddressAsyncThunk, { dispatch }) => {
    ...
    const daiContract = new ethers.Contract(addresses[networkID].CAND_ADDRESS as string, ierc20Abi, provider);
    ...
    const shecContract = new ethers.Contract(addresses[networkID].SCNYA_ADDRESS as string, sHECv2, provider);
