...
function Stake() {
  ...
  const onChangeStake = async (action, isOld) => {
    ...
    if (action === "stake" && gweiValue.gt(ethers.utils.parseUnits(hecBalance, "gwei"))) {
      return dispatch(error("You cannot stake more than your CNYA balance."));
    }

    if (action === "unstake" && gweiValue.gt(ethers.utils.parseUnits(unstakedVal, "gwei"))) {
      return dispatch(error("You cannot unstake more than your sCNYA balance."));
    }
    await dispatch(
      changeStake({
        address,
              ...
              {/* <div className="staking-area">
                {!address ? (
                  <div className="stake-wallet-notification">
                    ...
                    <Typography variant="h6">Connect your wallet to stake CNYA</Typography>
                  </div>
                ) : (
                  <>
                      ...
                      <Box className="stake-action-row " display="flex" alignItems="center">
                          ...
                          (!hasAllowance("hec") && view === 0) || (!hasAllowance("shec") && view === 1) ? (
                            <Box className="help-text">
                              <Typography variant="body1" className="stake-note" color="textSecondary">
                                {view === 0 ? (
                                  <>
                                    First time staking <b>CNYA</b>?
                                    <br />
                                    Please approve Dozen Dao to use your <b>CNYA</b> for staking.
                                  </>
                                ) : (
                                  <>
                                    First time unstaking <b>sCNYA</b>?
                                    <br />
                                    Please approve Dozen Dao to use your <b>sCNYA</b> for unstaking.
                                  </>
                                )}
                              </Typography>
                            </Box>
                        ...
                        <TabPanel value={view} index={0} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "staking", "Stake CNYA")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                        ...
                        <TabPanel value={view} index={1} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "unstaking", "Unstake CNYA")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                    ...
                    <div className={`stake-user-data`}>
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trim(hecBalance, 4)} CNYA</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trimmedBalance} sCNYA</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sCNYA</>}
                        </Typography>
                      </div>
