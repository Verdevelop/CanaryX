            ...
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric index">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of sCNYA accumulated since the beginning of staking. Basically, how much sCNYA one would have if they staked and held a single CNYA from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " sCNYA" : <Skeleton type="text" />}
                </Typography>
              </Box>
            </Box>
          </Paper>
