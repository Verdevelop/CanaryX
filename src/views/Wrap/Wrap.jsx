...
function Wrap() {
  ...
  const onChangeWrap = async action => {
    ...
    if (
      ...
      return dispatch(error("You cannot wrap more than your sCNYA balance."));
    }
    ...
    if (
      ...
      return dispatch(error("You cannot unwrap more than your wsCNYA balance."));
    }
                ...
                <Grid container spacing={2} alignItems="flex-end">
                  ...
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    <div className="wrap-index">
                      ...
                      <Typography variant="h4">
                        {currentIndex ? <>{trim(currentIndex, 2)} CNYA</> : <Skeleton width="150px" />}
                      </Typography>
                    </div>
                  </Grid>
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    <div className="wrap-wsHEC">
                      <Typography variant="h5" color="textSecondary">
                        ...
                        <InfoTooltip
                          message={
                            "wsCNYA = sCNYA * index\n\nThe price of wsCNYA is equal to the price of CNYA multiplied by the current index"
                          }
                        />
                      </Typography>
                      <Typography variant="h4">
            ...
            {/* <div className="staking-area">
              {!address ? (
                <div className="stake-wallet-notification">
                  ...
                  <Typography variant="h6">Connect your wallet to wrap sCNYA</Typography>
                </div>
              ) : (
                <>
                    ...
                    <Box className="stake-action-row " display="flex" alignItems="center" style={{ paddingBottom: 0 }}>
                        ...
                        !hasAllowance("sHEC") && view === 0 ? (
                          <Box className="help-text">
                            <Typography variant="body1" className="stake-note" color="textSecondary">
                              {view === 0 && (
                                <>
                                  First time wrapping <b>sCNYA</b>?
                                  <br />
                                  Please approve Dozen Dao to use your <b>sCNYA</b> for wrapping.
                                </>
                              )}
                            </Typography>
                          </Box>
                      ...
                      <TabPanel value={view} index={0} className="stake-tab-panel">
                        {address && hasAllowance("sHEC") ? (
                          ...
                          >
                            {txnButtonText(pendingTransactions, "wrapping", "Wrap sCNYA")}
                          </Button>
                        ) : (
                          <Button
                            className="stake-button"
                      ...
                      <TabPanel value={view} index={1} className="stake-tab-panel">
                        ...
                        >
                          {txnButtonText(pendingTransactions, "unwrapping", "Unwrap sCNYA")}
                        </Button>
                      </TabPanel>
                    </Box>
                    ...
                    {quantity && (
                      <Box padding={1}>
                        <Typography variant="body2" className={classes.textHighlight}>
                          {isUnwrap
                            ? `Unwrapping ${quantity} wsCNYA will result in ${trim(convertedQuantity, 4)} sCNYA`
                            : `Wrapping ${quantity} sCNYA will result in ${trim(convertedQuantity, 4)} wsCNYA`}
                        </Typography>
                      </Box>
                    )}
                  </Box>
                  ...
                  <div className={`stake-user-data`}>
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{trim(sHecBalance, 4)} sCNYA</>}
                      </Typography>
                    </div>
                    <div className="data-row">
                      <Typography variant="body1">Unwrappable Balance</Typography>
                      <Typography variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{trim(wsHecBalance, 4)} wsCNYA</>}
                      </Typography>
                    </div>
                  </div>
                </>
